  ...
  if (!certificates || certificates.length === 0) {
    return (
      <div style={{ background: 'white', borderRadius: 20, padding: '2rem', border: '1px solid #F0EDE8', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', fontWeight: 700, color: 'var(--color-heading)', margin: '0 0 0.5rem 0' }}>No Certificates Yet</h3>
        <p style={{ fontSize: '0.85rem', color: 'var(--color-body)', margin: 0 }}>Complete programs to earn verified certificates.</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
        <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', fontWeight: 700, color: 'var(--color-heading)', margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          📜 Certificates Earned ({certificates.length})
        </h3>
        <Link to="/certificates" style={{ fontSize: '0.82rem', fontWeight: 700, color: 'var(--color-primary)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
        ...
        {certificates.slice(0, 6).map((cert, i) => {
          ...
          return (
            ...
            >
              ...
              <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-heading)', margin: '0 0 0.3rem 0' }}>{name}</h4>
              {issueDate && (
                <p style={{ fontSize: '0.75rem', color: 'var(--color-body)', margin: '0 0 0.75rem 0' }}>
              ...
              {certId && (
                <button
                  ...
                  style={{
                    ...
                    border: '1px solid #BBF7D0', color: '#059669', fontSize: '0.78rem',
