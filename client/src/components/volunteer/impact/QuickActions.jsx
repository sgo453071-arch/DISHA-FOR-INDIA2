...
const QuickActions = () => {
  const actions = [
    ...
    { label: 'Open Wallet', icon: <Wallet size={18} />, path: '/notifications', color: '#D35400', bg: '#FFF3ED' },
  ...
  return (
    ...
    >
      <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', fontWeight: 700, color: 'var(--color-heading)', margin: '0 0 1.25rem 0' }}>Quick Actions</h3>
        ...
        {actions.map((action, i) => (
          <Link
            ...
            style={{
              ...
              color: action.color, textDecoration: 'none', fontWeight: 700, fontSize: '0.82rem',
