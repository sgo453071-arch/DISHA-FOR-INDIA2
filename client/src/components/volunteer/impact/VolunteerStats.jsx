...
const VolunteerStats = ({ stats }) => {
  ...
  const items = [
    ...
    { label: 'Hours Contributed', value: stats.hoursContributed ?? 0, icon: '⏱', color: '#7C3AED', bg: '#EDE9FE' },
    { label: 'Coins Earned', value: stats.coinsEarned ?? 0, icon: '🪙', color: '#D35400', bg: '#FFF3ED' },
